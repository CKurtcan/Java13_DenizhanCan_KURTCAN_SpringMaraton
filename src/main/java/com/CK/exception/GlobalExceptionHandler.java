...
import static com.CK.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> okulOtomasyonuHandler(HospitalException authServiceException){
